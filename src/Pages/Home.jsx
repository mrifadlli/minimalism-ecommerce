...
const Home = () => {
  return (
    <div className="mx-auto bg-[#eeeeee] px-6 lg:px-12 mb-3">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 mx-3 mt-14 mb-5 border-t-4 border-b-4 text-center items-center">
        ...
        <div className="lg:p-16 p-9 border-r-4 border-t-4 lg:border-r-4">
          <div className="flex justify-center mb-2">
