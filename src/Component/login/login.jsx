...
const Login = () => {
  return (
    <div className=" bg-[#eeeeee] py-8">
      <div className=" bg bg-[#eeeeee] min-h-screen flex items-center justify-center">
          ...
          <div className="w-10/12 max-w-[700px] px-10 py-20 rounded-3xl bg-white border-2 border-gray-100">
            ...
            <div className="mt-8">
              ...
              <div className="flex flex-col mt-4">
                ...
                <input className="w-full border-2 border-gray-100 rounded-xl p-4 mt-1 bg-transparent" placeholder="Enter your email" type={'password'} />
              </div>
              ...
              <div className="mt-8 flex justify-center items-center">
                ...
                <button className="ml-2 font-medium text-base text-blue-900">Sign up</button>
              </div>
            </div>
          </div>
          <div>
            <div className=" hidden relative lg:flex h-full w-1/2 items-center justify-center bg-gray-200"></div>
          </div>
        </div>
      </div>
    </div>
