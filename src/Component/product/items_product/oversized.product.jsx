...
import IklanProduct from '../../iklan_Product/iklan.product';
import FilterProduct from './../filter_product/filter.product';
import FiturProduct from '../fitur_product/fitur.product.jsx';
...
const OversizedProduct = () => {
    ...
    const filterOversized = currentProduct.filter((value) => 
        value.kategori === "oversized")
        ...
        <>
            <section>
                ...
                <div className='mb-20'> 
                    ...
                    {iklanProduct.filter((items) => items.kategori === "oversized")
                            .map((items,index) =>  (
                                    <IklanProduct
                                    image={items.image}
                                    title={items.title}
                    ...
                    <div className='lg:flex lg:justify-center lg:flex-row '>
                        ...
                        <div className='w-full lg:w-9/12 grid xs:grid-cols-2 
